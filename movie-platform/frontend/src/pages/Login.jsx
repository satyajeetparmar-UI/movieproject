    ...
    <div className="relative min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-black">
      ...
      <div className="relative z-10 max-w-[450px] w-full space-y-8 bg-black/75 p-16 rounded-md">
        ...
        <form className="mt-8 space-y-6" onSubmit={submitHandler}>
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              className="w-full flex justify-center py-4 px-4 border border-transparent text-md font-bold rounded text-white bg-[#E50914] hover:bg-[#c11119] transition mt-8 disabled:opacity-50"
            >
        ...
        <div className="mt-16 text-gray-400">
          New to MovieVerse?{' '}
          <Link to="/signup" className="text-white hover:underline transition font-medium">
            Sign up now.
          </Link>
